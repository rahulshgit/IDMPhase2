(:: pragma bea:global-element-parameter parameter="$cRM_UNLOCK_USERResponse1" element="ns4:CRM_UNLOCK_USERResponse" location="../Schema/IDM_Phase2.xsd" ::)
...
declare namespace xf = "http://tempuri.org/CustomerSystemUserAccount/Transaformation/XQ_IDMUnlockUserResponse_To_CRMUnlockUserResponse/";

declare function xf:XQ_IDMUnlockUserResponse_To_CRMUnlockUserResponse($cRM_UNLOCK_USERResponse1 as element(ns4:CRM_UNLOCK_USERResponse))
    as element(ns5:UpdateCustomerSystemUserAccountVBMResponse) {
        <ns5:UpdateCustomerSystemUserAccountVBMResponse>
            ...
            <ns3:IDs>
               <ns3:ID>{data($cRM_UNLOCK_USERResponse1/return/IDMAccountId)}</ns3:ID>
            </ns3:IDs>    
             <ns3:Categories>
...
declare variable $cRM_UNLOCK_USERResponse1 as element(ns4:CRM_UNLOCK_USERResponse) external;

xf:XQ_IDMUnlockUserResponse_To_CRMUnlockUserResponse($cRM_UNLOCK_USERResponse1)