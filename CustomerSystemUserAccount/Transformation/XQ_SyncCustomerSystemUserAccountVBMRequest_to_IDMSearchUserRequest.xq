...
declare namespace xf = "http://tempuri.org/CustomerSystemUserAccount/Transformation/XQ_CRMSyncUserRequest_to_IDMSearchUserRequest/";
...
declare function xf:XQ_CRMSyncUserRequest_to_IDMSearchUserRequest($syncCustomerSystemUserAccountVBMRequest1 as element(ns5:SyncCustomerSystemUserAccountVBMRequest),$transactionId)
    as element(ns0:CRM_SEARCH_ALL_USER) {
        <ns0:CRM_SEARCH_ALL_USER>
          <arg0>{data($syncCustomerSystemUserAccountVBMRequest1/*:CustomerSystemUserAccountVBO/*:IDs/*:ID)}</arg0>
            <arg1>		
			</arg1>
            <arg2>usr_key</arg2>
...
xf:XQ_CRMSyncUserRequest_to_IDMSearchUserRequest($syncCustomerSystemUserAccountVBMRequest1,$transactionId)